  ...
  return (
    <div style={{ maxWidth:720, margin:'0 auto', padding:'40px 20px 60px', fontFamily:"'Inter',sans-serif", color:'#1a1a1a', lineHeight:1.75 }}>
      ...
      <Section title="10. Sospensione e cancellazione">
        <p><strong>Da parte tua:</strong> puoi cancellare il tuo account in qualsiasi momento da Profilo → Elimina account, oppure richiedendolo a niarsstudio091@gmail.com o dalla pagina <a href="/elimina-account">motosnap.vercel.app/elimina-account</a>.</p>
      ...
      <Section title="13. Contatti">
        <p>
          Supporto: <a href="mailto:niarsstudio091@gmail.com" style={{ color:'#E8431F' }}>niarsstudio091@gmail.com</a><br/>
          Privacy/GDPR: <a href="mailto:niarsstudio091@gmail.com" style={{ color:'#E8431F' }}>niarsstudio091@gmail.com</a><br/>
          Segnalazioni abusi: <a href="mailto:niarsstudio091@gmail.com" style={{ color:'#E8431F' }}>niarsstudio091@gmail.com</a>
        </p>
      </Section>
