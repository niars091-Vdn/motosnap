export const metadata = { title: 'Termini di Servizio — MotoSnap' }
...
export default function TermsPage() {
  return (
    <div style={{ maxWidth:720, margin:'0 auto', padding:'40px 20px 60px', fontFamily:"'Inter',sans-serif", color:'#1a1a1a', lineHeight:1.75 }}>
      ...
      <p style={{ color:'#888', fontSize:13, marginBottom:32 }}>Ultima revisione: gennaio 2025</p>

      <Section title="1. Accettazione e requisiti">
        <p>Usando MotoSnap accetti questi Termini e la nostra <a href="/privacy">Privacy Policy</a>. Se non accetti, non usare il servizio.</p>
      ...
      <Section title="2. Descrizione del servizio">
        <p>MotoSnap è un&apos;applicazione web che offre:</p>
        <ul>
      ...
      <Section title="5. Contenuti della community">
        <p>Pubblicando contenuti su MotoSnap:</p>
        <ul>
      ...
      <Section title="6. AI e accuratezza">
        <ul>
          ...
          <li>MotoSnap non è un servizio di consulenza meccanica professionale</li>
        </ul>
      </Section>
      ...
      <Section title="7. Prodotti e link affiliati">
        <ul>
          ...
          <li>MotoSnap può ricevere commissioni su acquisti effettuati tramite i nostri link (programmi di affiliazione)</li>
      ...
      <Section title="8. Proprietà intellettuale">
        <p>MotoSnap, il logo, il design e il software sono di proprietà di MotoSnap e protetti da copyright. Non puoi:</p>
        <ul>
          <li>Copiare, riprodurre o distribuire il software dell&apos;app</li>
          <li>Fare reverse engineering</li>
          <li>Usare il marchio MotoSnap senza autorizzazione scritta</li>
        </ul>
      </Section>

      <Section title="9. Limitazione di responsabilità">
        <p>Nei limiti consentiti dalla legge italiana, MotoSnap non è responsabile per:</p>
        <ul>
        ...
        <p>La responsabilità massima di MotoSnap verso l&apos;utente è limitata all&apos;importo eventualmente pagato per il servizio negli ultimi 12 mesi.</p>
      </Section>

      <Section title="10. Sospensione e cancellazione">
        <p><strong>Da parte tua:</strong> puoi cancellare il tuo account in qualsiasi momento da Profilo → Impostazioni → Cancella account, o richiedendolo a privacy@motosnap.app.</p>
      ...
      <Section title="12. Legge applicabile e foro">
        <p>Questi Termini sono regolati dalla legge italiana. Per controversie che non si risolvono amichevolmente, è competente il Tribunale di Milano, salvo diversa disposizione obbligatoria di legge a tutela del consumatore.</p>
        <p style={{ fontSize:13, color:'#666', marginTop:8 }}>Per i consumatori UE: è disponibile la piattaforma ODR (Online Dispute Resolution) della Commissione Europea: <a href="https://ec.europa.eu/consumers/odr" target="_blank" style={{ color:'#2a6644' }}>ec.europa.eu/consumers/odr</a></p>
      </Section>

      <Section title="13. Contatti">
        <p>
          Supporto: <a href="mailto:support@motosnap.app" style={{ color:'#2a6644' }}>support@motosnap.app</a><br/>
          Privacy/GDPR: <a href="mailto:privacy@motosnap.app" style={{ color:'#2a6644' }}>privacy@motosnap.app</a><br/>
          Segnalazioni abusi: <a href="mailto:abuse@motosnap.app" style={{ color:'#2a6644' }}>abuse@motosnap.app</a>
        </p>
      </Section>

      <div style={{ borderTop:'1px solid #eee', paddingTop:20, marginTop:32, fontSize:12, color:'#aaa' }}>
        Termini di Servizio v1.0 · MotoSnap
      </div>
    </div>
  )
}
